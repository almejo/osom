...
class OperationSRA_r extends OperationCB {

	private final Register register;
	private final boolean lo;

	OperationSRA_r(Z80Cpu cpu, MMU mmu, int code, Register register, boolean lo) {
	...
	void execute() {
		...
		int result = ((oldValue >> 1) | (oldValue & 0x80)) & 0xFF;
